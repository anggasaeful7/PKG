					...
					<div class="tabs tabs-style-fillup">
						<nav class="row col-md-8">
							<ul>
								...
								<li><a href="#section-underline-2" class="icon icon-port fa-2x"><span>Data Siswa</span></a></li>
								<li><a href="#section-underline-3" class="icon icon-port fa-2x"><span>Data Kelas</span></a></li>
								<li><a href="#section-underline-4" class="icon icon-port fa-2x"><span>Data Wali Siswa</span></a></li>
								<li><a href="#section-underline-5" class="icon icon-display fa-2x"><span>Data Penilai</span></a></li>
								<li><a href="#section-underline-6" class="icon icon-university fa-2x"><span>Data Sekolah</span></a></li>
							</ul>
						</nav>
						...
						<div class="row col-md-12 content-wrap">
							...
							<section id="section-underline-2">
								<div class="card">
									<div class="header bar sisi-k">
										...
										<p class="category">Data Siswa PKG SMAN 4 Bandung</p>
									</div>
									<div class="content">
										<?php if($this->session->userdata('level')<=1){?>
											<div class="row sisi-k">
							...
							<section id="section-underline-3">
								<div class="card">
									<div class="header bar sisi-k">
										...
										<p class="category">Data Kelas PKG SMAN 4 Bandung</p>
									</div>
									<div class="content">
										<?php if($this->session->userdata('level')<=1){?>
											<div class="row sisi-k">
							...
							<section id="section-underline-4">
								<div class="card">
									<div class="header bar sisi-k">
										<h4 class="title">Data Wali Siswa</h4>
										<p class="category">Data Wali Siswa PKG SMAN 4 Bandung</p>
									</div>
									<div class="content">
										<?php if($this->session->userdata('level')<=1){?>
											<div class="row sisi-k">
